  ...
  return (
    ...
    <nav className='flex justify-around p-5 w-screen h-24 shadow-md'>
        ...
        <ul className='flex items-center list-none gap-14 text-lg '>
            ...
            <li className='flex flex-col items-center justify-center gap-1 cursor-pointer' onClick={()=>{setmenu("men")}}><Link href="/Men">Men{menu==="men"? <hr className='border-none w-11/12 h-1 rounded bg-red-600'/>:<></>}</Link></li>
            <li className='flex flex-col items-center justify-center gap-1 cursor-pointer  ' onClick={()=>{setmenu("women")}}><Link href="/Women">Women{menu==="women"? <hr className='border-none w-11/12 h-1 rounded bg-red-600'/>:<></>}</Link></li>
            <li className='flex flex-col items-center justify-center gap-1 cursor-pointer ' onClick={()=>{setmenu("kids")}}><Link href="/Kids">Kids{menu==="kids"? <hr className='border-none w-11/12 h-1 rounded bg-red-600'/>:<></>}</Link></li>
        </ul> 
